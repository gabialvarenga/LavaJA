      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '${solicitacao.placa ?? ''} · ${solicitacao.tipoServico.label.toLowerCase()}',
              style: const TextStyle(
                fontSize: 11,
  ...
  String get _subtitulo {
    switch (solicitacao.status) {
      case StatusSolicitacao.pendente:
        return 'Aguardando lavador';
      case StatusSolicitacao.aceita:
        return 'Lavador confirmou';
      case StatusSolicitacao.emExecucao:
        return 'Em execução agora';
