...
extension StatusSolicitacaoX on StatusSolicitacao {
  ...
  bool get isFinal =>
      this == StatusSolicitacao.concluida ||
      this == StatusSolicitacao.recusada ||
      this == StatusSolicitacao.cancelada;
}
...
class Solicitacao {
  ...
  factory Solicitacao.fromJson(Map<String, dynamic> json) {
    ...
    return Solicitacao(
      ...
      tipoServico: TipoServicoX.fromString(json['tipo_servico'] as String? ?? ''),
